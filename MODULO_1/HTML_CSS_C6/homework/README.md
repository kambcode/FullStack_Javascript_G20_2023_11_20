...
1. Replica la siguiente tarjeta usando flexbox:
    - La tarjeta debe tener un ancho de `300px` y estar centrada en el body vertical y horizontalemente. Si quieres centrar ka tarjeta en el body verticalmente, no olvides usar la propiedad `min-height: 100vh` en el body.
